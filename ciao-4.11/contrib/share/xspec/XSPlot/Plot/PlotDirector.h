...
class PlotDirector 
{
  ...
  public:
    ...
    typedef std::map<string,std::pair<string,Real>,XSutility::Nocase> UnitsContainer;
      ...
      const IntegerArray& lastCommandIndices () const;
      void lastCommandIndices (const IntegerArray& value);
  ...
  private: //## implementation
    // Data Members for Class Attributes
      ...
      IntegerArray m_lastCommandIndices;
...
inline const IntegerArray& PlotDirector::lastCommandIndices () const
{
  return m_lastCommandIndices;
}

inline void PlotDirector::lastCommandIndices (const IntegerArray& value)
{
