...
class LineList 
{
  ...
  public:
      ...
      static void setSearchResults(const string& results);
  ...
  private: //## implementation
    ...
    // Data Members for Associations
      ...
      // For retaining the results of the most recent call to
      // the 'identify' command.
      static string s_searchResults;
...
inline const std::string& LineList::searchResults()
{
   return s_searchResults;
}

inline void LineList::setSearchResults(const std::string& results)
{
   s_searchResults = results;
}
