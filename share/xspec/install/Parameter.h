...
class Parameter 
{
  ...
  public:
    ...
    class CantFreeze : public YellowAlert  //## Inherits: <unnamed>%3C110D9C0141
    {
      ...
      // This is the string modelName returns when there is no parent 
      //   (ie. the current situation for ResponseParams).
      static const string& NOPARENT();
  ...
  private: //## implementation
    // Data Members for Class Attributes
      ...
      static const string s_NOPARENT;
...
inline const string& Parameter::NOPARENT()
{
   return s_NOPARENT;
}
#endif
