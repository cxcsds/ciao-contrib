...
class Model 
{
  ...
  public:
    ...
    class WrongDataForMixing : public YellowAlert  //## Inherits: <unnamed>%3F671AAE0176
    {
      ...
      //
      //	It takes an optional IntegerVector as a parameter, which
      ...
      void destroy () throw ();
      void initializeMixingTransformation (bool isLowest, IntegerVector allMixSpectra = IntegerVector()) const;
