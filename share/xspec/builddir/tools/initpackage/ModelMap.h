...
class ModelMap
{
   ...
   public:
      ...
      static const string& f77funcType();
      static const string& CXXmixfuncType();

   protected:
      // This doesn't do anything unless overridden.
      virtual void addWrappers(const string& modName, const string& funcName, 
...
inline const string& ModelMap::f77funcType()
{
   return s_f77funcType;
}

inline const string& ModelMap::CXXmixfuncType()
{
   return s_CXXmixfuncType;
}
