...
class OGIPTable : public TableComponent  //## Inherits: <unnamed>%3D2EE1AB030B
{
  ...
  protected:
      ...
      const IntegerVector& recordNumbers () const;
      void setRecordNumbers (const IntegerVector& value);
      const IntegerVector& bracket () const;
      void setBracket (const IntegerVector& value);
  ...
  private: //## implementation
    ...
    // Data Members for Associations
      ...
      std::map<const UniqueEnergy*,IntegerVector> m_startWeightBin;
      std::map<const UniqueEnergy*,IntegerVector> m_endWeightBin;
      IntegerVector m_recordNumbers;
      IntegerVector m_bracket;
...
inline const IntegerVector& OGIPTable::recordNumbers () const
{
  return m_recordNumbers;
}

inline void OGIPTable::setRecordNumbers (const IntegerVector& value)
{
  m_recordNumbers = value;
}

inline const IntegerVector& OGIPTable::bracket () const
{
  return m_bracket;
}

inline void OGIPTable::setBracket (const IntegerVector& value)
{
  m_bracket = value;
}
