...
class OGIP_92aIO : public XspecDataIO  //## Inherits: <unnamed>%3AACF98E00CE
{
  ...
  public:
    ...
    typedef enum {NO_STORE, KEYSTORE, COLSTORE} StorageType;
      ...
      static std::unique_ptr<CCfits::FITS> openFitsExtension (const string& fileName, XspecDataIO::DataType type);
  ...
  protected:
      ...
      int verifyQualGroup (const int startChan, const int endChan, IntegerVector& qual, IntegerVector& group, size_t row = 0);
