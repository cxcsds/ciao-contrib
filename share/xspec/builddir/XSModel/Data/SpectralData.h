...
class SpectralData 
{
  ...
  public:
    ...
    typedef struct { size_t m_firstChan; size_t m_startChan; size_t m_endChan; size_t m_detChans;} ChannelInfo;
      ...
      void setChannels (bool value, IntegerVector& range);
      ...
      const IntegerVector& quality () const;
      void setQuality (const IntegerVector& value);
      int quality (size_t index) const;
      void quality (size_t index, int value);
      const IntegerVector& qualityInfo () const;
      void setQualityInfo (const IntegerVector& value);
      int qualityInfo (size_t index) const;
      void qualityInfo (size_t index, int value);
      const IntegerVector& groupingInfo () const;
      void setGroupingInfo (const IntegerVector& value);
  ...
  private: //## implementation
    ...
    // Data Members for Associations
      ...
      IntegerVector m_quality;
      IntegerVector m_qualityInfo;
      IntegerVector m_groupingInfo;
...
inline const IntegerVector& SpectralData::quality () const
{
  return m_quality;
}

inline void SpectralData::setQuality (const IntegerVector& value)
{
  m_quality = value;
}
...
inline const IntegerVector& SpectralData::qualityInfo () const
{
  return m_qualityInfo;
}

inline void SpectralData::setQualityInfo (const IntegerVector& value)
{
  m_qualityInfo = value;
}
...
inline const IntegerVector& SpectralData::groupingInfo () const
{
  return m_groupingInfo;
}

inline void SpectralData::setGroupingInfo (const IntegerVector& value)
{
