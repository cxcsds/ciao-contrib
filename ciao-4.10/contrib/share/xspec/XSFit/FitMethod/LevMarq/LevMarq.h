...
class LevMarq : public FitMethod  //## Inherits: <unnamed>%3B7AE241020E
{
  ...
  private:
     ...
     void curFitXspec (int& errorFlag, IntegerArray& errorPar);
     void calcNewPars (RealArray& parVals);
      void invertCorrelationMatrix ();
      void calcStatAndDerivatives (const RealArray& parValues, bool doDerivatives, int& errorFlag, IntegerArray& errorPar);
